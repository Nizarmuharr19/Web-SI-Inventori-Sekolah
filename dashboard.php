...
<br><br><h1 class="header-title">Dashboard</h1>
...
<div class="welcome-box">
  ...
  <p>
    Pantau kondisi barang, kelola peminjaman, serta pastikan inventaris tetap akurat.
    Gunakan menu navigasi di samping untuk mengakses seluruh fitur sistem.
    Selalu update data agar inventori sekolah tetap teratur dan efisien!
  </p>
</div>
